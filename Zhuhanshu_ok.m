...
%noise
img11_RGB = imread('epigastrium1.jpg'); 
img22_RGB = imread('hipjoint2.jpg'); 

img11_RGB = imread('hipjoint1.jpg'); 
img22_RGB = imread('hipjoint2.jpg'); 
...
% img11_RGB = imread('IDRiD_001.jpg'); 
% img22_RGB = imread('IDRiD_180.jpg'); 
...
% P1=imread("IM00055.jpg");
% P1=P1(:,:,1);
% P2=imread("IM00056.jpg");
% P2=P2(:,:,1);
% P3=imread("IM00057.jpg");
% P3=P3(:,:,1);
% P4=imread("IM00058.jpg");
% P4=P4(:,:,1);
% P5=imread("IM00059.jpg");
% P5=P5(:,:,1);
% P6=imread("IM00060.jpg");
% P6=P6(:,:,1);
...
re1=ssim(img11_RGB(:,:,n),jiamihou_1(:,:,n));
re2=ssim(img22_RGB(:,:,n),jiamihou_2(:,:,n));

re3=psnr(img11_RGB(:,:,n),jiamihou_1(:,:,n));
re4=psnr(img22_RGB(:,:,n),jiamihou_2(:,:,n));
...
imwrite(img11_RGB, 'o1.png');
imwrite(img22_RGB, 'o2.png');
imwrite(jiamihou_1, 'e1.png');
imwrite(jiamihou_2, 'e2.png');
